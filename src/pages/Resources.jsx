...
const Resources = () => {
    ...
    const fallbackResources = [
        {
            ...
            summary: 'Comprehensive notes on Paging, Segmentation, and Virtual Memory allocation strategies.',
            notes: '#',
            pyqs: '#'
        },
        {
            ...
            youtube: 'https://youtube.com',
            summary: 'Deep dive into the 4 layers of TCP/IP: Application, Transport, Internet, and Network Access.',
            notes: '#',
            pyqs: '#'
        },
        {
            ...
            icon: 'fa-database',
            youtube: 'https://youtube.com',
            summary: 'Step-by-step guide to 1NF, 2NF, 3NF, and BCNF with practical database examples.',
            notes: '#',
            pyqs: '#'
        }
    ];
    ...
    const dynamicResources = recommendations.map((rec, idx) => ({
        ...
        summary: rec.video?.summary || "No summary available for this lecture.",
        notes: '#',
        pyqs: '#'
    }));
                    ...
                    <div key={index} className="resource-card">
                        ...
                        <div className="resource-content">
                            ...
                            <div style={{ margin: '1rem 0', display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
                                ...
                                <button
                                    onClick={() => handleDownloadNotes(res.topic, res.summary)}
